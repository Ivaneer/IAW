...
<body>
    ...
    if (isset($_REQUEST['mod'])) {
        ...
        if ($filas['cuenta'] == 1) {
            $update = "UPDATE coches SET marca='$marca' where matricula='$matricula'";
            mysqli_query($conexion, $update) or die("Error delete de: " . mysqli_error($conexion));
            echo "Su vehiculo ha sido modificado de nuestro sistema";
        } else {
            echo "No existe ese coche con esa matricula";
        }
    }
